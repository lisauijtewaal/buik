  ...
  stress: {
    ...
    steps: {
      stress: {
        ...
        fact3: 'wist je dat in een periode van stress er met name klachten kunnen optreden rond de zwakke plekken van het lichaam. Vanzelfsprekend kan bij het prikkelbare darm syndroom de darm als zwakke plek gezien worden. Met stress verergeren de klachten van PDS daarom vaak.',
      ...
      angst: {
        ...
        textfield: 'Bij een gezond dagpatroon hoort ook de nodige mate van  ontspanning. Hoe zit het met jouw balans? Neem jij genoeg rust tussen alle bezigheden door? Verstandig! Doe je te veel of kom je niet genoeg aan activiteiten toe? Dat kan natuurlijk altijd. Dan kan het gebrek aan ontspanning een belangrijke prikkel zijn van jouw klachten.',
        image: require('../images/diaryCategory/stress/relax.jpg'),
        question: 'Hoe ontspannen voelde jij je vandaag?',
        fact3: 'wist je dat ontspannen spieren in de buik en bekkengebied een voorwaarde is voor ontspannen darmen.',
        type: 'angst',
